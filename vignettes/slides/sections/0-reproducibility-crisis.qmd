...
![**Nature's survey of 1,576 researchers on reproducibility in research**. Reproduced from [Fig1, *1,500 scientists lift the lid on reproducibility*](https://www.nature.com/articles/533452a), from @baker2016n.](images/reproducibility_crisis.webp){width="70%" style="border-radius:1em;margin-top:auto"}

#### Domain-dependant

![Physicists and chemists show the most confidence, in contrast with social or biological studies. Reproduced from [Fig2, *1,500 scientists lift the lid on reproducibility*](https://www.nature.com/articles/533452a), from @baker2016n.](images/reproducibility_crisis_dependant.webp){width="70%" style="border-radius:1em;margin-top:auto"}
:::
::::
...
###  {#repro-hackathon .scrollable .smaller data-menu-title="Reproducible Hackathons"}
...
:::::: columns
::: {.column width="75%"}
![Comparison of differentially expressed genes among 12 groups, illustrated by **upset plots**. Reproduced from [Fig.6, \@cokelaer2023b](https://academic.oup.com/view-large/figure/409576502/btad227f6.tif)](images/degs_reprohackathons.jpeg){width="70%" style="border-radius:1em;margin-top:auto"}
:::
...
-   **Conclusion**: DEGs poolry overlap between the groups, whereas all pipelines were runnable.
:::
::::
::::::
